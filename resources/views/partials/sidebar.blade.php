        ...
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto px-3 py-4">
                <ul class="space-y-1" id="nav-menu">
                    ...
                    <!-- Pelatihan -->
                    <li class="nav-item-submenu {{ Request::is('admin/pelatihan/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/pelatihan/*') ? 'rotate-180' : '' }}"
                        ...
                        <ul class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/pelatihan/*') ? '' : 'hidden' }}">
                    ...
                    <li class="nav-item-submenu {{ Request::is('admin/presensi/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/presensi/*') ? 'rotate-180' : '' }}"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <ul class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/presensi/*') ? '' : 'hidden' }}">
                            ...
                            <li class="nav-subitem {{ Request::is('admin/presensi/konsultasi*') ? 'active' : '' }}">
                                <a href="{{ route('konsultasiAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Konsultasi</span>
                                </a>
                    ...
                    <li class="nav-item-submenu {{ Request::is('admin/evaluasi/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/evaluasi/*') ? 'rotate-180' : '' }}"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <ul class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/evaluasi/*') ? '' : 'hidden' }}">
                            ...
                            <li class="nav-subitem {{ Request::is('admin/evaluasi/konsultasi*') ? 'active' : '' }}">
                                <a href="{{ route('evaluasiKonsultasiAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Konsultasi</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item-submenu {{ Request::is('admin/survey/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            class="nav-toggle flex items-center w-full p-3 text-gray-700 transition duration-200 rounded-lg hover:bg-gray-100 group"
                            data-submenu="survey">
                            <i class="la la-list text-lg text-gray-500 group-hover:text-gray-700"></i>
                            <span class="flex-1 ml-3 text-left">Survey Kepuasan</span>
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/survey/*') ? 'rotate-180' : '' }}"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <ul class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/survey/*') ? '' : 'hidden' }}">
                            <li class="nav-subitem {{ Request::is('admin/survey/reguler*') ? 'active' : '' }}">
                                <a href="{{ route('surveyRegulerAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Reguler</span>
                                </a>
                            </li>
                            <li class="nav-subitem {{ Request::is('admin/survey/permintaan*') ? 'active' : '' }}">
                                <a href="{{ route('surveyPermintaanAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Permintaan</span>
                                </a>
                            </li>
                            <li class="nav-subitem {{ Request::is('admin/survey/konsultasi*') ? 'active' : '' }}">
                                <a href="{{ route('surveyKonsultasiAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Konsultasi</span>
                                </a>
                            </li>
                    ...
                    <!-- Studi Kepuasan Pelatihan -->
                    <li class="nav-item-submenu {{ Request::is('admin/studidampak/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            class="nav-toggle flex items-center w-full p-3 text-gray-700 transition duration-200 rounded-lg hover:bg-gray-100 group"
                            data-submenu="studi">
                            <i class="la la-folder text-lg text-gray-500 group-hover:text-gray-700"></i>
                            <span class="flex-1 ml-3 text-left">Studi Kepuasan</span>
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/studidampak/*') ? 'rotate-180' : '' }}"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <ul
                            class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/studidampak/*') ? '' : 'hidden' }}">
                            <li class="nav-subitem {{ Request::is('admin/studidampak/reguler*') ? 'active' : '' }}">
                                <a href="{{ route('studiRegulerAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Reguler</span>
                                </a>
                            </li>
                            <li
                                class="nav-subitem {{ Request::is('admin/studidampak/permintaan*') ? 'active' : '' }}">
                                <a href="{{ route('studiPermintaanAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Permintaan</span>
                                </a>
                            </li>
                            <li
                                class="nav-subitem {{ Request::is('admin/studidampak/konsultasi*') ? 'active' : '' }}">
                                <a href="{{ route('studiKonsultasiAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Konsultasi</span>
                                </a>
                            </li>
                    ...
                    <li
                        class="nav-item-submenu {{ Request::is('admin/sertifikat-pelatihan/*') ? 'active-parent' : '' }}">
                        <button type="button"
                            class="nav-toggle flex items-center w-full p-3 text-gray-700 transition duration-200 rounded-lg hover:bg-gray-100 group"
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 submenu-chevron {{ Request::is('admin/sertifikat-pelatihan/*') ? 'rotate-180' : '' }}"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                        ...
                        <ul
                            class="submenu ml-8 mt-1 space-y-1 {{ Request::is('admin/sertifikat-pelatihan/*') ? '' : 'hidden' }}">
                            <li
                                class="nav-subitem {{ Request::is('admin/sertifikat-pelatihan/reguler*') ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-subitem {{ Request::is('admin/sertifikat-pelatihan/permintaan*') ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-subitem {{ Request::is('admin/sertifikat-pelatihan/konsultasi*') ? 'active' : '' }}">
                                <a href="{{ route('sertiKonsultasiAdmin') }}"
                                    class="nav-link flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-900">
                                    <span>Konsultasi</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item {{ Request::is('admin/fasilitator/*') ? 'active' : '' }}">
                        <a href="{{ route('fasilitatorAdmin') }}"
                            ...
                            <span class="ml-3">Fasilitator</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item {{ Request::is('admin/alumni/*') ? 'active' : '' }}">
                        <a href="#"
                            ...
                            <span class="ml-3">Alumni Peserta</span>
                        </a>
                    </li>
