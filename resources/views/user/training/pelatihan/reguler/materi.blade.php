{{-- resources/views/user/training/pelatihan/reguler/materi.blade.php --}}
                    ...
                    <div class="text-center">
                        <div class="flex items-center justify-center mb-4">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-gray-600">{{ $reguler->nama_pelatihan ?? 'Pelatihan' }}</p>
                            </div>
                        </div>
                    ...
                    @else
                        ...
                        <div class="text-center py-16" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="flex flex-wrap justify-center gap-4">
                                {{-- <a href="{{ route('reguler.pelatihan.list') }}"
