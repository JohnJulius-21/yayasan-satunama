...
@section('content')
    <div class="mb-8">
        ...
        <p class="text-gray-600">Riwayat kehadiran Anda dalam pelatihan {{ $permintaan->nama_pelatihan }}</p>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-500 text-white"
                                        href="{{ route('scanQrPresensiPermintaan', ['id' => $permintaan->id_pelatihan_permintaan, 'presensi' => $p->id_presensi]) }}">
                                        👁️ Lihat Presensi
                                    </a>
                                </td>
                            </tr>
