                ...
                <div class="col-lg-12">
                    <div class="php-email-form">
                        ...
                        @elseif (!empty($formData) && is_array($formData) && count($formData) > 0)
                            <form id="form-eval" action="{{ route('permintaan.pelatihan.studi.store') }}" method="POST">
                                @csrf
                                ...
                                <input type="hidden" name="id_pelatihan_permintaan"
    ...
    <script>
        jQuery(function($) {
            ...
            $('#submitBtn').click(function(e) {
                ...
                $.ajax({
                    url: "{{ route('permintaan.pelatihan.studi.store') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                    ...
                    error: function(xhr) {
                        Swal.fire({
                            ...
                            window.location.href =
                                "{{ route('permintaan.pelatihan.studi-dampak', ['id' => $permintaan->id_pelatihan_permintaan]) }}";
                        });
                    }
                });
            });
