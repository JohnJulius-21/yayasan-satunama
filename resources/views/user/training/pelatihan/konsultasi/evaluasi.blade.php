                ...
                <div class="col-lg-12">
                    <div class="php-email-form">
                        ...
                        @elseif (!empty($formData) && is_array($formData) && count($formData) > 0)
                            ...
                            <form action="{{ route('konsultasi.pelatihan.evaluasi.store') }}" method="POST" id="form-eval">
                                @csrf
                                <input type="hidden" name="form_source" value="pelatihan">
                                <input type="hidden" id="data_respons" name="data_respons">
                                <input type="hidden" name="id_pelatihan_konsultasi" value="{{ $konsultasi->id_pelatihan_konsultasi }}">
                                <input type="hidden" id="id_peserta" name="id_peserta"
                                    value="{{ $peserta->id_peserta_konsultasi }}">
    ...
    <script>
        jQuery(function($) {
            ...
            $('#submitBtn').click(function(e) {
                ...
                $.ajax({
                    url: "{{ route('konsultasi.pelatihan.evaluasi.store') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
