<div class="container">
    <form class="login" action="{{ route('loginAdmin') }}" method="post">
        ...
        <img src="{{ asset('images/stc.png') }}" alt="Logo">
        {{-- <h2>Welcome, Admin!</h2> --}}
        <p>Silahkan log in</p>

        <input type="username" placeholder="Masukkan username" name="username" value="{{ old('username') }}" />
        @error('username')
        ...
        <div class="border-bottom mt-2">
            <a href="{{ route('reset.password.input') }}" style="color: #1a6304">Lupa Password?</a>
        </div>
