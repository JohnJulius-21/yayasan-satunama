...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('studiPermintaanAdmin') }}" style="color: green !important;">Studi Dampak Permintaan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Detail Studi Dampak {{ $permintaan->nama_pelatihan }}</li>
        </ol>
    </nav>
    @if (session('success'))
        <script>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        <h6 class="h4">Detail Studi Dampak Permintaan</h6>

        <div class="d-flex justify-content-end">
            @if ($showButtons)
                <a href="{{ url('/admin/studidampak/buat-form-studidampak-permintaan/' . $permintaan->id_pelatihan_permintaan) }}"
                    class="btn btn-success "><i style="width:17px" data-feather="plus"></i>
                    Buat Form Studi Dampak</a>
            @else
                <a href="{{ url('/admin/studidampak/edit-form-studidampak-permintaan/' . $permintaan->id_pelatihan_permintaan) }}"
                    class="btn btn-warning py-2 mx-1">Edit
                    Form</a>
                    ...
                    <tbody>
                        @foreach ($pesertaStatus as $peserta)
                            <tr>
                                ...
                                <td>{{ $peserta->hasilStudiPermintaan ? 'Sudah Mengisi' : 'Belum Mengisi' }}</td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('studidampakDeletePermintaanAdmin', $permintaan->id_pelatihan_permintaan) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
