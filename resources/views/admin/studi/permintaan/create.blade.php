...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('studidampakShowPermintaanAdmin', $permintaan->id_pelatihan_permintaan) }}"
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Buat Form Studi Dampak Pelatihan Permintaan</h6>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('studidampakStorePermintaanAdmin') }}" method="post"
                style="display: none;">
                @csrf
