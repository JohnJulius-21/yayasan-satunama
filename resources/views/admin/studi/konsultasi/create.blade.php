...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Buat Form Studi Dampak Konsultasi</h6>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('studidampakStoreKonsultasiAdmin') }}" method="post" style="display: none;">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" id="id_pelatihan_konsultasi" name="id_pelatihan_konsultasi" value="{{ $konsultasi->id_pelatihan_konsultasi }}">
            </form>
