    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        ...
        <div class="d-flex justify-content-end">
            ...
            @foreach ($permintaan_pelatihan as $item)
                <a href="{{ route('permintaanCreatePeserta', $item->id_pelatihan_permintaan) }}"
                    class="btn btn-success mx-1"><i class="la la-plus"></i> Buatkan Akun Peserta</a>
            @endforeach
        </div>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                {{-- <a class="btn btn-secondary mt-4" href="{{ route('permintaanAdmin') }}">Kembali</a> --}}
            </div>
        </div>
    </div>
