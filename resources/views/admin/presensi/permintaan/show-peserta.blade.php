@extends('layouts.app')
@section('title', 'Admin |  Presensi Peserta Pelatihan Permintaan')
@section('content')
    <style>
    ...
    <a href="{{ url('/admin/presensi/list-permintaan/' . $presensi->id_permintaan)}}" class="back-icon mb-3"
       title="Kembali">
        ←
    </a>
            ...
            $('#permintaan').DataTable({
                layout: {
                    topStart: {
                        buttons: [{
                            extend: 'pdf',
                            title: 'Data Presensi Peserta Pelatihan {{ $presensi->judul_presensi ?? "Presensi Permintaan" }}',
