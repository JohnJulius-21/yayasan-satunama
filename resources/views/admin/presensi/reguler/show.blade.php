@extends('layouts.app')
@section('title', 'Admin |  Daftar Presensi Pelatihan Reguler')
...
@section('content')
    ...
    <a href="{{ route('adminPresensiReguler')}}" class="back-icon mb-3" title="Kembali">
        ←
    </a>
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 mb-8 text-white shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold mb-2">Presensi Pelatihan Reguler</h1>
                <p class="text-green-100">Kelola dan buat presensi untuk pelatihan reguler</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-md border border-gray-100 sticky top-6">
                ...
                <div class="p-6">
                    <form id="hidden-form" action="{{ route('savePresensi', $reguler->id_reguler) }}" method="post" class="space-y-4">
                        @csrf
                        <div>
