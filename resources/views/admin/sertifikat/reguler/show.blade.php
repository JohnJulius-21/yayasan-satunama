    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('sertiRegulerAdmin') }}" style="color: green !important;">Reguler</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Upload Sertifikat Pelatihan</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Daftar Peserta Pelatihan {{ $reguler->nama_pelatihan }}</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="upload-form"
                                            action="{{ route('sertiRegulerUploadAdmin', $p->id_peserta_reguler) }}"
