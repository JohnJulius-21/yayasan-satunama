@extends('layouts.app')
@section('title', 'Admin | Sertifikat Pelatihan Permintaan')
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Pelatihan Permintaan</h6>
    </div>
    @if (session('success'))
        <script>
    ...
    <x-data-table
        ...
        :columns="$columns"
        :add-button="false"
        search-route="{{ route('sertiPermintaanAdmin') }}"
...
{{--                                    </td>--}}
{{--                                    <td>--}}
{{--                                        <a href="{{ route('sertiPermintaanShowAdmin', $item->id_pelatihan_permintaan) }}"--}}
