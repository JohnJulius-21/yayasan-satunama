    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('surveyPermintaanAdmin') }}" style="color: green !important;">Survey Kepuasan Permintaan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Detail Survey Kepuasan {{ $permintaan->nama_pelatihan }}</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        <h6 class="h4">Detail Survey Kepuasan Permintaan</h6>
        <div class="d-flex justify-content-end">
            @if ($showButtons)
                <a href="{{ route('surveyCreatePermintaanAdmin', $permintaan->id_pelatihan_permintaan) }}"
                    class="btn btn-success "><i style="width:17px" data-feather="plus"></i>
                    Buat Form Survey Kepuasan</a>
            @else
                <a href="{{ url('/admin/survey/edit-form-survey-permintaan/' . $permintaan->id_pelatihan_permintaan) }}"
                    ...
                    <tbody>
                        @foreach ($pesertaStatus as $peserta)
                            <tr>
                                ...
                                <td>{{ $peserta->hasilSurveyPermintaan ? 'Sudah Mengisi' : 'Belum Mengisi' }}</td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('surveyDeletePermintaanAdmin', $permintaan->id_pelatihan_permintaan) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
