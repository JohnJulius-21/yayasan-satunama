...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('surveyShowPermintaanAdmin', $form->id_pelatihan_permintaan) }}" style="color: green !important;">Detail
                    Survey Kepuasan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Edit Survey Pelatihan Permintaan</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Edit Form Survey Kepuasan Pelatihan Permintaan</h6>
    </div>
    @if (session('warning'))
        <script>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('surveyUpdatePermintaanAdmin', ['id' => $id]) }}" method="post">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" name="id_pelatihan_permintaan" value="{{ $id }}">
    ...
    <script>
        jQuery(function($) {
            ...
            formBuilderPromise.then(function(formBuilder) {
                $.ajax({
                    url: "{{ route('surveyEditPermintaanAdmin', ['id' => $id]) }}",
                    type: 'GET',
