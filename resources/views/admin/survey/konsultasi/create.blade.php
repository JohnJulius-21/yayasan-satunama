...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('surveyKonsultasiAdmin') }}" style="color: green !important;">Survey Kepuasan</a>
            </li>
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('surveyShowKonsultasiAdmin', $konsultasi->id_pelatihan_konsultasi) }}"
                    style="color: green !important;">Detail
                    Survey Kepuasan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Buat Survey Pelatihan Konsultasi</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Buat Form Survey Kepuasan Konsultasi</h6>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('surveyStoreKonsultasiAdmin') }}" method="post" style="display: none;">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" id="id_pelatihan_konsultasi" name="id_pelatihan_konsultasi"
