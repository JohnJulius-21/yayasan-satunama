...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('surveyShowKonsultasiAdmin', $form->id_pelatihan_konsultasi) }}"
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Edit Form Survey Kepuasan Konsultasi</h6>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('surveyUpdateKonsultasiAdmin', ['id' => $id]) }}" method="post">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" name="id_pelatihan_konsultasi" value="{{ $id }}">
    ...
    <script>
        jQuery(function($) {
            ...
            formBuilderPromise.then(function(formBuilder) {
                $.ajax({
                    url: "{{ route('surveyEditKonsultasiAdmin', ['id' => $id]) }}",
                    type: 'GET',
