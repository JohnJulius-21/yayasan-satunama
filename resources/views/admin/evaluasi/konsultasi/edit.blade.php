...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('evaluasiShowKonsultasiAdmin', $form->id_pelatihan_konsultasi) }}"
                    style="color: green !important;">Detail
                    Evaluasi</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Edit Form Evaluasi Pelatihan Konsultasi</li>
        </ol>
    </nav>
    @if (session('warning'))
        <script>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Edit Evaluasi Pelatihan Konsultasi</h6>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('evaluasiUpdateKonsultasiAdmin', ['id' => $id]) }}" method="post">
                @csrf
    ...
    <script>
        jQuery(function($) {
            ...
            formBuilderPromise.then(function(formBuilder) {
                $.ajax({
                    url: "{{ route('evaluasiEditKonsultasiAdmin', ['id' => $id]) }}",
                    type: 'GET',
