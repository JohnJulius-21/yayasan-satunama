...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Detail Evaluasi {{ $reguler->nama_pelatihan }}</li>
        </ol>
    </nav>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Detail Evaluasi Pelatihan Reguler</h6>
        <div class="d-flex justify-content-end">
            @if ($showButtons)
                <a href="{{ route('evaluasiCreateRegulerAdmin', $reguler->id_reguler) }}" class="btn btn-success px-2">
                    <i style="width:17px" data-feather="plus"></i> Buat Form Evaluasi
                </a>
            @else
                    ...
                    <tbody>
                        @foreach ($pesertaStatus as $peserta)
                            <tr>
                                ...
                                <td>{{ $peserta->hasilEvaluasiReguler ? 'Sudah Mengisi' : 'Belum Mengisi' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                @else
                    <table id="evaluasi" class="display table table-bordered dataTable"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('evaluasiDeleteRegulerAdmin', $reguler->id_reguler) }}" method="POST">
                        @csrf
                        @method('DELETE')
