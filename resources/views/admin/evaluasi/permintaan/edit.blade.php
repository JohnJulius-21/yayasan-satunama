...
@section('content')
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: rgb(2, 160, 2) !important;">
                <a href="{{ route('evaluasiShowPermintaanAdmin', $form->id_pelatihan_permintaan) }}"
                    style="color: green !important;">Detail Evaluasi</a>
            </li>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h6 class="h4">Edit Evaluasi Pelatihan Permintaan</h6>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('evaluasiUpdatePermintaanAdmin', ['id' => $id]) }}" method="post">
                @csrf
