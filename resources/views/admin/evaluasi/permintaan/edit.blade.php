...
@section('content')
    ...
    <a href="{{ route('evaluasiShowPermintaanAdmin', $form->id_pelatihan_permintaan)}}" class="back-icon mb-3"
       title="Kembali">
        ←
    </a>
    <!-- Breadcrumb -->
...
{{--            <li>--}}
{{--                <a href="{{ route('evaluasiShowPermintaanAdmin', $form->id_pelatihan_permintaan) }}" class="text-green-600 hover:text-green-800">Detail Evaluasi</a>--}}
{{--            </li>--}}
{{--            <li class="text-gray-500">/</li>--}}
{{--            <li class="text-gray-700" aria-current="page">Edit Form Evaluasi Pelatihan Permintaan</li>--}}
{{--        </ol>--}}
{{--    </nav>--}}
    ...
    <div class="bg-white shadow-lg rounded-lg mb-6">
        <div class="px-6 py-3 border-b border-gray-200">
            <h6 class="text-lg font-semibold text-green-600">Edit Form Evaluasi</h6>
        </div>

        <div class="p-6">
            {{-- Hidden form for storing form data --}}
            <form id="hidden-form" action="{{ route('evaluasiUpdatePermintaanAdmin', ['id' => $id]) }}" method="post" class="hidden">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" name="id_permintaan_pelatihan" value="{{ $id }}">
            </form>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('evaluasiShowPermintaanAdmin', $form->id_pelatihan_permintaan) }}"
    ...
    <script>
            ...
            try {
                ...
                $('#save-button').on('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: "Apakah Anda yakin ingin menyimpan perubahan form evaluasi pelatihan permintaan ini?",
                        icon: 'question',
        ...
        function loadExistingFormData(formBuilderInstance) {
            ...
            Swal.fire({
                title: 'Memuat data...',
                text: 'Sedang mengambil data form evaluasi permintaan',
                allowOutsideClick: false,
                didOpen: () => {
                    Swal.showLoading();
                }
            ...
            $.ajax({
                url: "{{ route('evaluasiEditPermintaanAdmin', ['id' => $id]) }}",
                type: 'GET',
