...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Detail Evaluasi {{ $permintaan->nama_pelatihan }}</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        <h6 class="h4">Detail Evaluasi Pelatihan Permintaan</h6>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('evaluasiDeletePermintaanAdmin', $permintaan->id_pelatihan_permintaan) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
