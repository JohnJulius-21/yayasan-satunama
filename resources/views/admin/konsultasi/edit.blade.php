...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Pelatihan Konsultasi</li>
        </ol>
    </nav>
    ...
    <form method="post" action="{{ route('konsultasiUpdateAdmin', $konsultasi->id_pelatihan_konsultasi) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT') 

        {{-- <input type="hidden" name="id_konsultasi" value="{{ $konsultasi->id_pelatihan_konsultasi }}"> --}}
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_pelatihan') is-invalid @enderror"
                                ...
                                value="{{ old('nama_pelatihan', $konsultasi->nama_pelatihan) }}" autofocus>
                            ...
                            <select class="form-control" name="id_tema">
                                ...
                                @foreach ($tema as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('id_tema', $konsultasi->id_tema) == $item->id ? 'selected' : '' }}>
                                        {{ $item->judul_tema }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="metode_pelatihan">
                                <option value="Online"
                                    {{ old('metode_pelatihan', $konsultasi->metode_pelatihan) == 'Online' ? 'selected' : '' }}>
                                    Online</option>
                                <option value="Offline"
                                    {{ old('metode_pelatihan', $konsultasi->metode_pelatihan) == 'Offline' ? 'selected' : '' }}>
                                    Offline</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lokasi_pelatihan') is-invalid @enderror"
                                ...
                                value="{{ old('lokasi_pelatihan', $konsultasi->lokasi_pelatihan) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="ckeditor form-control" name="deskripsi_pelatihan">{{ old('deskripsi_pelatihan', $konsultasi->deskripsi_pelatihan) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="date" id="tanggal_mulai" class="form-control" name="tanggal_mulai"
                                value="{{ old('tanggal_mulai', $konsultasi->tanggal_mulai) }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="tanggal_selesai" class="form-control" name="tanggal_selesai"
                                value="{{ old('tanggal_selesai', $konsultasi->tanggal_selesai) }}">
                        </div>
                    </div>
                </div>
