...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="color: green !important;">
                <a href="{{ route('konsultasiInfoAdmin', $konsultasi->id_pelatihan_konsultasi) }}"
                    style="color: rgb(2, 160, 2) !important;">
                    Informasi Pelatihan
                </a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Daftar Akun Peserta Konsultasi</li>
        </ol>
    </nav>
    @if (session('success'))
        <script>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <h1 class="h4">Daftar Peserta Konsultasi</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-start">
                <p class="m-0 font-weight-bold text-success">Peserta</p>
            </div>
        </div>
        <div class="card-body">
    ...
    <div id="createPesertaModal" class="custom-modal">
        <div class="custom-modal-content">
            ...
            <div class="custom-modal-body">
                <form method="post" action="{{ route('konsultasiStorePeserta', $konsultasi->id_pelatihan_konsultasi) }}"
                    enctype="multipart/form-data">
                    @csrf
                    {{-- @foreach ($konsultasi as $item) --}}
                    <input type="hidden" id="id_konsultasi" name="id_konsultasi" value="{{ $konsultasi->id_pelatihan_konsultasi }}">
                    {{-- @endforeach --}}
                    <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-edit').click(function() {
                ...
                let actionUrl = "/admin/pelatihan/konsultasi/update-peserta-konsultasi/" + id;
            ...
            $('.btn-delete').click(function() {
                let id = $(this).data('id');
                let actionUrl = "/admin/pelatihan/konsultasi/hapus-peserta-konsultasi/" + id;
                $('#deleteForm').attr('action', actionUrl);
