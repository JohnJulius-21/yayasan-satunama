        ...
        <div class="col-lg-6 col-md-10 mb-1">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="mt-3">Dimana Peserta Mendapatkan Informasi Pelatihan</h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const asalPesertaChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: {!! json_encode($informasiPeserta->pluck('informasi')) !!},
                    datasets: [{
                        label: 'Jumlah Peserta',
                        data: {!! json_encode($informasiPeserta->pluck('total')) !!},
