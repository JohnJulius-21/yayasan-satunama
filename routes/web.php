...
Route::get('/admin/surveykepuasan', [SurveyController::class, 'indexReguler'])->name('surveyRegulerAdmin');
...
Route::get('/admin/studidampak', [StudiController::class, 'indexReguler'])->name('studiRegulerAdmin');
